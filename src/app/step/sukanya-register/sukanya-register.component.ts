...
@Component({
  selector: 'app-sukanya-register',
  templateUrl: './sukanya-register.component.html',
  styleUrls: ['./sukanya-register.component.css']
})
export class SukanyaRegisterComponent implements OnInit {
